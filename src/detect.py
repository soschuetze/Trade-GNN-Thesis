...
def get_args():
    ...
    parser.add_argument('--model_name', type=str, default='sage-gdp-mis-norm')
    parser.add_argument('--model_path', type=str, default='../saved-models/sage-gdp-mis_norm', help='Path to model for detecting change-points.')
    parser.add_argument('--save_dir', type=str, default='../cpd-results/sage-gdp-mis-norm/', help='Name of folder where to store results')
